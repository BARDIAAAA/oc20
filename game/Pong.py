...
def draw(canvas):
    ...
    hit_left_wall = int(ball_pos[0]) <= BALL_RADIUS + PAD_WIDTH
    hit_paddle_a = paddle1_pos[1] - HALF_PAD_HEIGHT < ball_pos[1] < paddle1_pos[1] + HALF_PAD_HEIGHT
    ...
    hit_paddle_b = paddle2_pos[1] - HALF_PAD_HEIGHT < ball_pos[1] < paddle2_pos[1] + HALF_PAD_HEIGHT
    ...
    #update scores
    myfont1 = pygame.font.SysFont("MS", 50)
    label1 = myfont1.render("Score "+str(left_score), 1, (RED))
    canvas.blit(label1, (50,20))

    myfont2 = pygame.font.SysFont("MS", 50)
    label2 = myfont2.render("Score "+str(right_score), 1, (BLUE))
